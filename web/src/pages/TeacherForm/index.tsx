...
const TeacherForm: React.FC = () => {
  ...
  const handleCreateClass = useCallback(
    ...
    [name, avatar, whatsapp, bio, subject, scheduleItems, cost, history]
  );

  const setScheduleItemValue = useCallback(
    (position: number, field: string, value: string) => {
      setScheduleItems((preState) =>
        preState.map((scheduleItem, index) => {
          if (index === position) {
  ...
  return (
    <div id="page-teacher-form" className="container">
      <PageHeader
        title="Que incrível que voce quer dar aula"
